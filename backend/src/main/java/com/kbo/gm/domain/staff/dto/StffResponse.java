...
public class StffResponse {
    ...
    public static StffResponse from(StffDao dao) {
        return StffResponse.builder()
                .stffId(dao.getStffId())
                .stffNm(dao.getStffNm())
                .stffEngNm(dao.getStffEngNm())
                .stffTypeCd(dao.getStffTypeCd())
                .stffTypeNm(dao.getStffTypeNm())
                .stffNtnlt(dao.getStffNtnlt())
                .stffFrgnYn(dao.getStffFrgnYn())
                .stffBrthDt(dao.getStffBrthDt())
                .stffExpYr(dao.getStffExpYr())
                .stffAnslSal(dao.getStffAnslSal())
                .stffSttsCd(dao.getStffSttsCd())
                .tmId(dao.getTmId())
