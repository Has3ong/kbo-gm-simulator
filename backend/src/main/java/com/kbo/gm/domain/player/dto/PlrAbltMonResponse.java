...
import com.kbo.gm.domain.player.dao.PlrAbltMonDao;
...
@NoArgsConstructor
@AllArgsConstructor
public class PlrAbltMonResponse {
    ...
    public static PlrAbltMonResponse from(PlrAbltMonDao dao) {
        return PlrAbltMonResponse.builder()
                .plrId(dao.getPlrId())
