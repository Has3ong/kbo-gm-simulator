...
import com.kbo.gm.domain.player.dao.PlrPtchMonRecDao;
...
@NoArgsConstructor
@AllArgsConstructor
public class PlrPtchMonRecResponse {
    ...
    private Integer ipOut;   // 투구 아웃카운트 (이닝 × 3)
    ...
    public static PlrPtchMonRecResponse from(PlrPtchMonRecDao dao) {
        return PlrPtchMonRecResponse.builder()
                .plrId(dao.getPlrId())
