...
import com.kbo.gm.domain.team.dao.TmMarketDao;
...
public class TmMarketResponse {
    ...
    public static TmMarketResponse from(TmMarketDao dao) {
        return TmMarketResponse.builder()
                .tmId(dao.getTmId())
                .ssntYr(dao.getSsntYr())
                .mktSz(dao.getMktSz())
                .ppltRtg(dao.getPpltRtg())
                .fanLylty(dao.getFanLylty())
                .fanExp(dao.getFanExp())
                .regIntrst(dao.getRegIntrst())
                .natnlPplt(dao.getNatnlPplt())
                .mrchPwr(dao.getMrchPwr())
                .avgAtndCnt(dao.getAvgAtndCnt())
                .ssntTcktHldr(dao.getSsntTcktHldr())
                .build();
    }
}
